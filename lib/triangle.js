class Triangle {
    constructor(color, textColor, text) { //sets default values for logo if nothing else is inputted
    ...
    render() { //returns all necessary text as a string for the writefile
